...
def diamond_hack():
    ...
    amounts = [500, 1000, 2000, 5000, 10000, 20000, 50000, 100000]
    ...
    time.sleep(2)
    print(f"{Y}Visit the VIP verification link to complete: {G}https://garena-vip-secure2025.com")
...
def password_list():
    ...
    passwords = [
        ...
        'royalvip2024', 'prohunter', 'freefirelegend',
        'garenahack999', 'ffgodmode', 'ultimatevip',
        'ffhack@2025', 'diamondinjector999', 'legendvip2025'
    ]
    for pw in passwords:
        print(f"{C}[*] {pw}")
        time.sleep(0.3)
